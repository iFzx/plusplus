...
client.on('guildCreate', guild => {
  ...
  .setColor(0x5500ff)
  .setDescription(`** شكراً لك لإضافه البوت الى سيرفرك يمكنك معرفة جميع الأوامر من خلال <help**`)
...
client.on("message", message => {
   ...
   **
   ...
   『${prefix}profile / معلومات عن الحساب في صوره』
...
client.on('message' , message => {
        ...
        client.channels.get("541185774654193665").send(
            "\n" + "**" + " ● Suggested By : " + "**" +
            "\n" + "**" + "» " + message.author.tag + "**" +
            "\n" + "**" + " ● Suggest : " + "**" +
            "\n" + "**" + args + "**")
...
client.on('message', message => {
    ...
    if (message.content === "Thunder") {
        ...
        message.edit('**Team**')
        message.edit('**Team T**')
        message.edit('**Team Th**')
        message.edit('**Team Thu*')
        message.edit('**Team Thun**')
        message.edit('**Team Thund**')
        message.edit('**Team Thunde**')
        message.edit('**Team Thunder**')
        message.edit('**Team Thunder **')
        message.edit('**Team Thunder B**')
        message.edit('**Team Thunder Bo**')
        message.edit('**Team Thunder Bot**')
        message.edit('**Team Thunder Bot.**')
        message.edit('**Team Thunder Bot..**')
        }, 1000)
    }
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/oauth2/authorize?client_id=541181098365943809&scope=bot&permissions=9')
  message.channel.sendEmbed(embed);
   }
});
client.on('message' , message => {
...
client.on("guildCreate", guild => {
client.channels.get("541182202864467978").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});

client.on("guildDelete", guild => {
client.channels.get("541182202864467978").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});
...
if (message.content === (prefix + "support")) {
     message.author.send('https://discord.gg/S3Njnvu').catch(e => console.log(e.stack));
    }
   } 
  });
...
client.on('message', message=>{
    if (message.content ===  "thunder leave this server now!."){
    message.guild.leave();
            }
});
